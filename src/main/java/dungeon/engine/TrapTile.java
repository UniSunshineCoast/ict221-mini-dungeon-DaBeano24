...
public class TrapTile extends Tile {
    ...
    public void interact(Pawn pawn, int difficulty) {
        ...
        if (pawn.isGameOver()) {
            pawn.getEngine().log("You stepped on a trap and lost health! Game Over.");
        } else {
            pawn.getEngine().log("You stepped on a trap and lost" + damage + " health. Current health: " + pawn.whatsHp());
        }
    }
    @Override
